...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d.height, a2 = d.width, u = e.offsetHeight, c2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g4 = $(), it = k2(), lt = h(), L, N2, ot = "top";
    f2.top + u + s4 > lt.height ? (L = f2.top + g4 - s4, ot = "bottom", L < 0 && (L = g4)) : L = u + f2.top + g4, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + c2 - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x2(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x2(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
  ...
  if (p(e)) {
    ...
    if (z(a2, k3)) {
      let n = a2.replaceAll(k3, (l2) => {
        let c2 = l2.replace(/{|}/g, "").split(".").filter((m2) => !s4.some((d) => z(m2, d)));
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let h2 = m2[u], f2 = ve(h2), p3 = z(u, a2) ? Q3(d) : Q3(d, ee(u));
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re } = a2, f2 = te || {}, { colorScheme: K2 } = f2, A2 = v3(f2, ["colorScheme"]), x4 = re || {}, { colorScheme: X2 } = x4, G3 = v3(x4, ["colorScheme"]), p3 = K2 || {}, { dark: U3 } = p3, B2 = v3(p3, ["dark"]), y3 = X2 || {}, { dark: I2 } = y3, H = v3(y3, ["dark"]), W3 = s(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s(B2) ? this._toVariables({ light: B2 }, n) : {}, pe = s(U3) ? this._toVariables({ dark: U3 }, n) : {}, fe = s(G3) ? this._toVariables({ semantic: G3 }, n) : {}, ye = s(H) ? this._toVariables({ light: H }, n) : {}, Se = s(I2) ? this._toVariables({ dark: I2 }, n) : {}, [Me, ze] = [(R3 = W3.declarations) != null ? R3 : "", W3.tokens], [Ke, Xe] = [(T2 = q2.declarations) != null ? T2 : "", q2.tokens || []], [Ge, Ue] = [(j2 = Z.declarations) != null ? j2 : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M3 = fe.declarations) != null ? M3 : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V2 = Se.declarations) != null ? V2 : "", Se.tokens || []];
    ...
    d = `${et2}${tt2}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], h2 = m(a2.css, { dt: E2 });
  }
  ...
  if (s(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t2, { colorScheme: R3, extend: T2, css: j2 } = m2, O2 = v3(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M3 } = d, z3 = v3(d, ["colorScheme"]), u = R3 || {}, { dark: V2 } = u, L = v3(u, ["dark"]), h2 = M3 || {}, { dark: te } = h2, re = v3(h2, ["dark"]), K2 = s(O2) ? this._toVariables({ [y3]: g3(g3({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y3]: g3(g3({}, L), re) }, r) : {}, X2 = s(V2) ? this._toVariables({ [y3]: g3(g3({}, V2), te) }, r) : {}, [G3, U3] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x4 = A2.declarations) != null ? x4 : "", A2.tokens || []], [H, W3] = [(p3 = X2.declarations) != null ? p3 : "", X2.tokens || []], q2 = this.transformCSS(y3, `${G3}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H, "dark", "variable", r, i2, a2, n);
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    Object.entries(l2).forEach(([m2, d]) => {
      let u = z(m2, t2.variable.excludedKeyRegex) ? o : o ? `${o}.${oe(m2)}` : oe(m2), h2 = c2 ? `${c2}.${m2}` : m2;
      i(d) ? n(d, u, h2) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x4 = {}, p3 = []) => {
  ...
  return n.length === 1 ? n[0].value : n.reduce((o = {}, c2) => {
    let u = c2, { colorScheme: m2 } = u, d = v3(u, ["colorScheme"]);
    return o[m2] = d, o;
  }, void 0);
}, getSelectorRule(e, t2, r, s4) {
  return r === "class" || r === "attr" ? C3(s(t2) ? `${e}${t2},${e} ${t2}` : e, s4) : C3(e, C3(t2 != null ? t2 : ":root", s4));
}, transformCSS(e, t2, r, s4, i2 = {}, a2, n, l2) {
  if (s(t2)) {
    let { cssLayer: o } = i2;
    if (s4 !== "style") {
      let c2 = this.getColorSchemeOption(i2, n);
      t2 = r === "dark" ? c2.reduce((m2, { type: d, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d, t2)), m2), "") : C3(l2 != null ? l2 : ":root", t2);
    }
    if (o) {
...
var script = {
  ...
  beforeMount: function beforeMount() {
    var _this$$el;
    this.rootEl = z2(p2(this.$el) ? this.$el : (_this$$el = this.$el) === null || _this$$el === void 0 ? void 0 : _this$$el.parentElement, "[".concat(this.$attrSelector, "]"));
    if (this.rootEl) {
  ...
  computed: {
    ...
    $inProps: function $inProps() {
      ...
      return Object.fromEntries(Object.entries(this.$props).filter(function(_ref0) {
        var _ref1 = _slicedToArray2(_ref0, 1), k4 = _ref1[0];
        return nodePropKeys === null || nodePropKeys === void 0 ? void 0 : nodePropKeys.includes(k4);
      }));
    },
...
//# sourceMappingURL=chunk-SAZCZJJK.js.map
